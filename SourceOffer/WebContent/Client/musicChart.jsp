...
<body data-type="chart">
	...
	<%
		...
		SqlConst musicSqlConst = new SqlConst(sql);
		ResultSet musicResultSet = musicSqlConst.getPst().executeQuery(sql);
	%>
                          ...
                          <div class="am-g">
                              <div class="am-u-sm-12">
                                      ...
                                      <table class="am-table am-table-striped am-table-hover table-main">
                                          ...
                                          %>
                                              <tr>
                                                  <td><%=musicResultSet.getInt("id") %></td>
                                                  <td><%=musicResultSet.getString("title") %></td>
                                                  <td><%=musicResultSet.getString("link")%></td>
                                                  <td><%=musicResultSet.getString("type")%></td>
                                                  <td>
                                                  <form action="deleteMusic">
                                                              <input type="hidden" name="id" value=<%=musicResultSet.getInt("id") %>>
