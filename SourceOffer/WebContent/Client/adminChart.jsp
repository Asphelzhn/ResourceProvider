...
<body data-type="chart">
              ...
              <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                  ...
                  <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                      <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                          <span class="tpl-header-list-user-nick"><%=session.getAttribute("adminname")%></span><span class="tpl-header-list-user-ico"> <img src="assets/img/user01.png"></span>
                      </a>
	...
	<%
		...
		SqlConst adminSqlConst = new SqlConst(sql);
		ResultSet adminResultSet = adminSqlConst.getPst().executeQuery(sql);
	%>
                          ...
                          <div class="am-g">
                              <div class="am-u-sm-12">
                                      ...
                                      <table class="am-table am-table-striped am-table-hover table-main">
                                          ...
                                          %>
                                              <tr>
                                                  <td><%=adminResultSet.getInt("id") %></td>
                                                  <td><%=adminResultSet.getString("adminname")%></td>
